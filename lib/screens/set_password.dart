...
class SetPassWodPage extends StatefulWidget {
  @override
  _SetPassWodPageState createState() => _SetPassWodPageState();
}

class _SetPassWodPageState extends State<SetPassWodPage> {
  var indexSelect = 0;
  String code = '';
  String msg = "";
                                ...
                                Expanded(
                                  ...
                                  child: FlatButton(
                                    ...
                                    onPressed: () async {
                                      if (code.isEmpty) {
                                        msg =
                                            "هیچ رمزی برای برناهم تعیین نکرده اید";
                                        showTostMassege();
                                        return null;
                                      }
                                      if (code.length < 4) {
                                        msg =
                                            "رمز عبور برنامه نباید از 4 کاراکتر کمتر باشد";
                                        showTostMassege();
                                        return null;
                                      }
